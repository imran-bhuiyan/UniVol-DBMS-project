...
<head>
    ...
    <title>Authority Event Details</title>
...
<body class="bg-gray-100">
    ...
    $query = "SELECT * FROM event_details WHERE faculty_id = $autho_id AND date>='$currentDate' ORDER BY date";
                ...
                <div class="card-body ">
                    ...
                    <div class="flex">
                        <div class="ml-32">
                            ...
                            <p class="mt-4 italic text-red-400"><b>Registration Deadline:
                                </b><?php echo $eventDetails['deadline']; ?>
                            </p>
                        </div>
