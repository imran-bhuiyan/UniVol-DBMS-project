...
<section class="container mx-auto mt-6 text-gray-800">
    ...
    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 max-w-2xl mx-auto" action="admin_create_club.php"
        method="POST">
        <h4 class="text-2xl font-bold text-center">Create Club</h4>
        ...
        <div class="mb-4">
            ...
            <input
                ...
                id="id" type="text" name="id" placeholder="Enter Club ID" value="<?php echo htmlspecialchars($id) ?>">
