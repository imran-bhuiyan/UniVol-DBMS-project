...
if (isset($_POST['change_password'])) {
    ...
    $query = "SELECT password FROM authority WHERE id = '$userID'";
    ...
    if ($result) {
        ...
        if ($current_password == $stored_password) {
            if ($new_password == $confirm_password) {
                ...
                $query_update = "UPDATE authority SET password = '$new_password' WHERE id = '$userID'";
...
<body>
    ...
    <section class="container mx-auto mt-8 mb-1 text-gray-800">
        <div>
            ...
            <form class=" bg-white shadow-md rounded px-16 pt-6 pb-8 mb-4 w-1/2 mx-auto"
                action="authority_pass_change.php" method="POST">
