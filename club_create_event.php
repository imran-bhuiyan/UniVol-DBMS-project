...
$name = $description = $req_skill = $date = $time = $location  =$deadline= $vol_count = '';
$errors = array(
...
if (isset($_POST['submit'])) {
    ...
    if (array_filter($errors)) {
        ...
        $sql = "INSERT INTO event_details (name, description, req_skill, date, time, location, req_club_id, faculty_id, vol_count,stat,deadline,remaining_member)
                VALUES ('$name', '$description', '$req_skill', '$date', '$time', '$location', '$req_club_id', '0', '$vol_count','pending','$deadline','$vol_count')";
...
<body class="bg-cupcake">
    ...
    <section class="container mx-auto mt-6 text-gray-800">
        ...
        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 max-w-2xl mx-auto" action="club_create_event.php"
            method="POST">
